...
describe('pcs-stats', () => {
    it('should parse pcs stats create event correctly', () => {
        const fullLog =
            'api:debug:pcs-stats:room created | retriedTimes - country FR pcType publisher token 578ae9c5-9875-471e-96f3-5f06c3e5534a _entity 56c2cd0a-7d9e-4b76-85be-944ae3b32ee9 _user d6e25ce8-bbe3-4494-8e9d-711cf1ad819e _client 2a729f00-8185-4832-87e6-ddfe4449ee84 sinceCreation 0ms sincePrevious -ms +1ms';
    ...
    it('should parse pcs stats created event correctly', () => {
        const fullLog =
            'api:debug:pcs-stats:room Created | retriedTimes 2 token 02010338-170f-40ee-814d-fdc41db86d53 _entity e815eae8-98ad-4dd7-b470-acbccd4db0a5 _user d6e25ce8-bbe3-4494-8e9d-711cf1ad819e _client 2a729f00-8185-4832-87e6-ddfe4449ee84';
        const { body: log, head } = prepareLog(fullLog);
        expect(parser(log, head)).toStrictEqual({
            parser: 'room-pcs-stats',
